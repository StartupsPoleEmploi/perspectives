        ...
        form =>
          candidatQueryHandler.handle(
            CandidatsPourConseillerQuery(
              ...
              rechercheParLieuHabitation = form.rechercheParLieuHabitation,
              rechercheParSecteurMrs = form.rechercheParSecteurMrs,
              rechercheParDateInscription = form.rechercheParDateInscription,
