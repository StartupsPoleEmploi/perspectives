  ...
  "importerOffres" should {
    "ne rien faire si aucune ligne n'est présente dans la source" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi""".stripMargin)
      )
    ...
    "ignorer la ligne si elle ne contient pas l'id de l'offre" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;;2019-10-01;35410;H3101;Conducteur / Conductrice de machines à onduler (H/F);GRANVILLE (50);32992501005763;ENTREPRISE;50400;RH ENTREPRISE;test@email.fr""".stripMargin)
      )
    ...
    "ignorer la ligne si elle ne contient pas le code postal" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;H3101;Conducteur / Conductrice de machines à onduler (H/F);GRANVILLE (50);32992501005763;ENTREPRISE;;RH ENTREPRISE;test@email.fr""".stripMargin)
      )
    ...
    "ignorer la ligne si elle ne contient pas de code postal valide" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;H3101;Conducteur / Conductrice de machines à onduler (H/F);GRANVILLE (50);32992501005763;ENTREPRISE;123456789;RH ENTREPRISE;test@email.fr""".stripMargin)
      )
    ...
    "ignorer la ligne si elle ne contient pas de code postal cible" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;H3101;Conducteur / Conductrice de machines à onduler (H/F);GRANVILLE (50);32992501005763;ENTREPRISE;19100;RH ENTREPRISE;test@email.fr""".stripMargin)
      )
    ...
    "ignorer la ligne si elle ne contient pas le mail du recruteur" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;H3101;Conducteur / Conductrice de machines à onduler (H/F);GRANVILLE (50);32992501005763;ENTREPRISE;50400;RH ENTREPRISE;""".stripMargin)
      )
    ...
    "ignorer la ligne si elle contient un mail de recruteur null" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;H3101;Conducteur / Conductrice de machines à onduler (H/F);GRANVILLE (50);32992501005763;ENTREPRISE;50400;RH ENTREPRISE;null""".stripMargin)
      )
    ...
    "ignorer la ligne si elle ne contient pas le nom de l'enseigne qui recrute" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;H3101;Conducteur / Conductrice de machines à onduler (H/F);GRANVILLE (50);32992501005763;;50400;RH ENTREPRISE;test@email.fr""".stripMargin)
      )
    ...
    "ignorer la ligne si elle ne contient pas le code ROME de l'offre" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;;Conducteur / Conductrice de machines à onduler (H/F);GRANVILLE (50);32992501005763;ENTREPRISE;50400;RH ENTREPRISE;test@email.fr""".stripMargin)
      )
    ...
    "ignorer la ligne si elle ne contient pas le nom de l'offre" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;H3101;;GRANVILLE (50);32992501005763;ENTREPRISE;50400;RH ENTREPRISE;test@email.fr""".stripMargin)
      )
    ...
    "ignorer la ligne si elle ne contient pas le lieu de travail de l'offre" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;H3101;Conducteur / Conductrice de machines à onduler (H/F);;32992501005763;ENTREPRISE;50400;RH ENTREPRISE;test@email.fr""".stripMargin)
      )
    ...
    "integrer la ligne lorsqu'elle contient toutes les informations" in {
      ...
      val source = Source.single(
        ByteString(
          """preselection_deduite;kc_offre;dd_datecreationreport;unite_suivi;dc_rome_id;intitule;lieu_de_travail;siret;enseigne;code_postal;nom_prenom_correspondant_offre;mail_suivi
            |non;094DLLY;2019-10-01;35410;H3101;Conducteur / Conductrice de machines à onduler (H/F);GRANVILLE (50);32992501005763;ENTREPRISE;50400;RH ENTREPRISE;test@email.fr""".stripMargin)
      )
