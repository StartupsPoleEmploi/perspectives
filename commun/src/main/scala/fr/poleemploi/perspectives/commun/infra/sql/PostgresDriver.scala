...
trait PostgresDriver extends ExPostgresProfile
  ...
  object PostgresAPI extends API
    ...
    implicit val codeSafirColumnType: BaseColumnType[CodeSafir] = mapStringValueObject(CodeSafir(_))
    ...
    implicit val resultatMrsColumnType: BaseColumnType[ResultatMrs] = mapStringValueObject(ResultatMrs(_))
    ...
    implicit val emailColumnType: BaseColumnType[Email] = mapStringValueObject(Email(_))
