...
class ImportOffresEnDifficulteGereesParRecruteurCSVAdapter(override val config: ImportFileAdapterConfig,
  ...
  override val pattern: String = "perspectives_offres_difficulte_sans_preselection_delta_*.bz2"
