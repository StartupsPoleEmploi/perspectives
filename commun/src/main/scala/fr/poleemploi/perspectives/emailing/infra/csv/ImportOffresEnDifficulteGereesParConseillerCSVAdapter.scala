...
class ImportOffresEnDifficulteGereesParConseillerCSVAdapter(override val config: ImportFileAdapterConfig,
  ...
  override val pattern: String = "perspectives_offres_difficulte_avec_preselection_delta_*.bz2"
